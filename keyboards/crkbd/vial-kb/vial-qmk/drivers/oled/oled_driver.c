...
bool oled_init(oled_rotation_t rotation) {
    ...
    if (!HAS_FLAGS(oled_rotation, OLED_ROTATION_180)) {
        static const uint8_t PROGMEM display_normal[] = {
            I2C_CMD, SEGMENT_REMAP, COM_SCAN_DEC, DISPLAY_OFFSET, OLED_COM_PIN_OFFSET,
        };
        ...
        static const uint8_t PROGMEM display_flipped[] = {
            I2C_CMD, SEGMENT_REMAP_INV, COM_SCAN_INC, DISPLAY_OFFSET, (OLED_COM_PIN_COUNT - OLED_COM_PIN_OFFSET) % OLED_COM_PIN_COUNT,
        };
